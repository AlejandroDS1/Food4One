...
public interface OnClickDetailListener {
    ...
    private ScrollPerfilAdapter.OnClickDetailListener mOnClickHideListener; // Qui hagi de repintar la ReciclerView
    ...
    public void setOnClickDetailListener(ScrollPerfilAdapter.OnClickDetailListener listener) {
...
public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Recipe recetaUser, ScrollPerfilAdapter.OnClickDetailListener listener) {
