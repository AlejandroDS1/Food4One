...
public class DoRecipeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeViewModel.setDao(getApplicationContext());
    ...
    private void initListeners() {
        binding.addIngredientsToListDoRecipe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                homeViewModel.saveIngredientesDB(ingredientsAdapter.selectedIngredientes);
            }
        });

        binding.removeDB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                homeViewModel.deleteDB();
            }
        });
    }
